; ModuleID = 'priority.c'
source_filename = "priority.c"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-linux-gnu"

@.str = private unnamed_addr constant [30 x i8] c"(a + b) * c / d \E7\9A\84\E5\80\BC\E6\98\AF %d\0A\00", align 1
...
define dso_local signext i32 @main() #0 {
  ...
  %14 = call signext i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef signext %13)
  ret i32 0
}
